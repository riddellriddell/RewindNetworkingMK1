...
namespace SimDataInterpolation
{
	...
	public class InterpolatedFrameDataGen : IInterpolatedFrameData<FrameData>
	{
		...
		public System.Single[] m_fixTimeUntilLaserFire;
																																									
		public System.Single[] m_fixTimeUntilLaserFireErrorOffset; 

		public System.Single[] m_fixTimeUntilLaserFireErrorAdjusted;
		...
		public void MatchFormat(FrameData fdaFrameData)
		{
			...
			if(m_fixTimeUntilLaserFire == null || m_fixTimeUntilLaserFire.Length != fdaFrameData.m_fixTimeUntilLaserFire.Length)
			{
				m_fixTimeUntilLaserFire = new System.Single[fdaFrameData.m_fixTimeUntilLaserFire.Length] ;

																																									
				m_fixTimeUntilLaserFireErrorOffset = new System.Single[fdaFrameData.m_fixTimeUntilLaserFire.Length] ;

				m_fixTimeUntilLaserFireErrorAdjusted = new System.Single[fdaFrameData.m_fixTimeUntilLaserFire.Length] ;
