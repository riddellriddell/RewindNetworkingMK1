...
namespace Sim
{
    public class GameSimulation
    {
        ...
        //
        //public GameSettingsInterfaceDepricated m_setGameSettings;
        //
        ...
        //
        //public GameSimulation(GameSettingsInterfaceDepricated setSttings, ConstData conConstantData)
        //{           
        ...
        //}
        //
        //public void SetupInitalFrameData(FrameData frmFirstFrame, GameSettingsInterfaceDepricated setGameSettings)
        //{
        //    //set the inital health of all players
        //    for(int i = 0; i < frmFirstFrame.m_sShipHealths.Count; i++)
        //    {
        //        frmFirstFrame.m_sShipHealths[i] = setGameSettings.PlayerHealth;
        //    }
        //
        ...
        //public bool SimulateFrame(GameSettingsInterfaceDepricated setSettings, ConstData conConstantGameData, List<InputBuffer> ipbPlayerInputs, List<byte> bInputsForTick, FrameData frmFrameToSimulate, FrameData frmSimulatedFrame)
        //{
        ...
        //}
        //
        //public bool PerformMoveProcess(GameSettingsInterfaceDepricated setSettings, ConstData conConstantGameData, List<byte> bInputsForTick, FrameData frmCurrentFrame, FrameData frmUpdatedFrame)
        //{
        //    //get the tick delta
        ...
        //}
        //
        //public bool PerformCollisionDetection(GameSettingsInterfaceDepricated setSettings, FrameData frmCurrentFrame, FrameData frmUpdatedFrame)
        //{
        //    List<FixVec2> outPlayerPos = frmUpdatedFrame.m_v2iPosition;
        //
        //    List<FixVec2> inPlayerPos = frmCurrentFrame.m_v2iPosition;
        ...
        //{
        //    for (int i = 0; i < frmCurrentFrame.m_sShipHealths.Count; i++)
        //    {
        //        //blit across health
        //        frmUpdatedFrame.m_sShipHealths[i] = frmCurrentFrame.m_sShipHealths[i];
        //    }
        //
        //    return true;
        //}
        ...
        //}
        //
        //public bool PerformAttackActions(GameSettingsInterfaceDepricated setSettings, ConstData conConstantGameData, List<byte> bInputsForTick, FrameData frmCurrentFrame, FrameData frmUpdatedFrame)
        //{
        //    //get refferences to the arrays that we will be processing
        //    List<byte> inPlayerStates = frmCurrentFrame.m_bPlayerState;
        //    List<byte> outPlayerStates = frmUpdatedFrame.m_bPlayerState;
        ...
        //                            {
        //                                frmUpdatedFrame.m_sShipHealths[iCollisionIndex] = 0;
        //                            }
        //                            else if (iAttackAlignment > 1) //check if blocked by shield 
        //                            {
        //                                //apply damage 
        //                                frmUpdatedFrame.m_sShipHealths[iCollisionIndex] = (short)(frmUpdatedFrame.m_sShipHealths[iCollisionIndex] - sDamage);
        //                            }
        //                        }
        //                        else
        //                        {
        ...
        //}
        //
        //public bool CheckForDeath(GameSettingsInterfaceDepricated setSettings, FrameData frmUpdatedFrame)
        //{
        ...
        //
        //    for(int i = 0; i < frmUpdatedFrame.m_sShipHealths.Count; i++)
        //    {
        //        if(frmUpdatedFrame.m_sShipHealths[i] <= 0)
        //        {
        ...
        //
        //    GetFrameData(iTick).GetHash(bHash);
        //
        //    return bHash;
        //}
        //
        //public bool GetPlayersOverlappingCircle(GameSettingsInterfaceDepricated setSettings, FrameData frmCurrentFrame, FixVec2 vecCenter, Fix fSize, int iPlayer, List<short> sPlayersHit)
        //{
